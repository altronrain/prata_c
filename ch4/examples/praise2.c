...
Здравствуйте, Кирилл. Вы - выдающаяся личность.
Ваше имя состоит из 12 символов и занимает 40 ячеек памяти.
Хвалебная фраза содержит 45 символов и занимает 46 ячеек памяти.
*/